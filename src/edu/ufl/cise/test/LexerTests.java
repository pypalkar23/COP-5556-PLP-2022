...
class LexerTest {
    ...
    void checkToken(IToken t, Kind expectedKind, int expectedLine, int
            expectedColumn) {
        assertEquals(expectedKind, t.getKind());
    ...
    void checkIdent(IToken t, String expectedName, int expectedLine, int
            expectedColumn) {
    ...
    void checkInt(IToken t, int expectedValue, int expectedLine, int
            expectedColumn) {
